    ...
    return (
        <div>
            <div className='DownloadContainer'>
                <br />
                <div className="oooo">
                    <p className="p3">선택한 옵션</p>
                    <p className="p3">자격증 시험 종류 : {examType.examType}</p>
                    <p className="p3">시험년도 : {selectedItems.year}</p>
                    <p className="p3">시험회차: {selectedItems.examRound}</p>
                    <p className="p3">답안지 종류: {selectedItems.answerType}</p>
